...
static int test_parse_crc_total_too_small(void)
{
    uint8_t buf[8] = {
        ...
        0x00, /* seq */
        0x00,
        0x01, /* length_field=1 => total_len=2 */
        0x01,
        0x00 /* sec hdr: CRC present, rem_len=0 => sec_len=2 */
    };
...
static int test_parse_no_crc_total_too_small(void)
{
    uint8_t buf[8] = {
        ...
        0x00, /* seq */
        0x00,
        0x00, /* length_field=0 => total_len=1 */
        0x00,
        0x00 /* sec hdr: CRC absent, rem_len=0 => sec_len=2 */
    };
...
static int test_parse_no_crc_payload_truncated(void)
{
    uint8_t buf[8] = {
        ...
        0x00, /* seq */
        0x00,
        0x02, /* length_field=2 => total_len=3, payload should be 1 byte */
        0x00,
        0x00 /* sec hdr: CRC absent, rem_len=0 => sec_len=2 */
    };
...
static int test_parse_declared_secheader_too_long(void)
{
    uint8_t buf[8] = {
        ...
        0x00, /* seq */
        0x00,
        0x05, /* any total_len >= 2 */
        0x00,
        0x03 /* sec hdr: rem_len=3 => sec_len=5, but only 2 bytes present */
    };
